...
<div class="col">
   ...
   <div class="alert alert-danger alert-dismissible fade show" role="alert">Incorrect username or password.</div> -->
            <form onsubmit="return checkForm_utente(this);" action="{{ url('/salvaUtenti') }}" method="post">
                @csrf
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary" name="CreaAmmnistratore">Invia</button>
                </div>
            </form>
        </div>
    </div>
