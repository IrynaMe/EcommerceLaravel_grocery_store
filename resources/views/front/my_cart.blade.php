        ...
        <div class="w3l_banner_nav_right">
            ...
            <div class="privacy about">
                ...
                <div class="checkout-right">
                    <h4>Your shopping cart contains: <span>{{ $product['totalQty'] }}</span></h4>
                                ...
                                @foreach ($products as $product)
                                    <tr class="rem1">
                                        ...
                                        <td class="invert-image"><a href="single.html">
                                                <img src="/tema/{{ $product['product_image'] }}" alt=" "
                ...
                <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
                    <div class="w3_footer_grid_bottom">
                        ...
                        <ul class="agileits_social_icons">
                            ...
                            <li><a href="#" class="instagram"><i class="fa fa-instagram"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="#" class="dribbble"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
